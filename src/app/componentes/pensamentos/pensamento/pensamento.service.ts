...
export class PensamentoService {
  ...
  constructor(private http: HttpClient) { }
   ...
   mudarFavorito(pensamento: Pensamento):Observable<Pensamento>{
    ...
    const url = `${this.API}/${pensamento.id}`        //|  esses dois comando sao iguais ao metodo editar
    return this.http.put<Pensamento>(url,pensamento)  //| entao pode ser subistituida por return this.editar(pensamento)
   }
